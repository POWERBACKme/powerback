module.exports = [
  ...
  },
  {
    ...
    term: 'Any legal actions, suits, or proceedings arising out of or relating to these Terms of Use shall be subject to the exclusive jurisdiction of the courts located within the jurisdiction where POWERBACK is based.',
  },
  {
  ...
  },
  {
    ...
    term: "In addition to our payment processing vendor costs, users are charged about 0.1% (one-tenth of one percent) overhead to keep donations whole within one cent. While there's no technical time limit to issuing a refund through the API or in the dashboard, we recommend users create refunds no more than 90 days after a payment was created. Refunds will only be considered for cases where donations were made in some express violation of the Eligibility requirements. Refunds issued within this period are more likely to behave as expected, ensuring successful fund transfers back to users' bank. After 90 days, there is no guarantee of a refund, although we will always attempt to process refunds. It is the user's responsibility to verify the validity of the account or card number before initiating a refund for a charge. For donations made under the condition that an elected official leaves Congress before the end of their term (e.g., dies, falls ill, retires, resigns, etc.), refunds will be processed in accordance with the agreed-upon Terms. If refunds cannot be processed due to processing errors or any other reason, users agree that the donation money will be given directly to POWERBACK to be used at POWERBACK's discretion. We do not guarantee the accuracy or completeness of any data we provide. Users acknowledge that the data they rely on to make spending decisions through us may contain errors and omissions.",
  },
  {
...

  {
    ...
    term: 'These Terms of Use, together with our Privacy Policy, constitute the entire agreement between you and POWERBACK regarding your use of the web application, superseding any prior agreements or understandings, whether oral or written.',
  },
  {
    section: 'Contact Information',
    term: 'If you have any questions about these Terms of Use, please contact us at legal@powerback.me.',
  },
];
